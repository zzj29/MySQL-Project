...
<body>
  ...
  <?php
    #for UPDATE, pull date from DB where cabinID = the one to update 
    $cID = $_GET['cabinID'];
    echo "The CabinID you are going to update is: Cabin " . $cID;
  ...
  <section>
    ...
    <form action="UpdateCabin_process.php" method="post">
        <br>
